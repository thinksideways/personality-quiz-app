...
### Module 3 Lab B (branch: module-3-lab-b)
...
### Module 3 Lab C (branch: module-3-lab-c)
...
### Module 3 Lab D (branch: module-3-lab-d)

Rewrite the Quiz App.  The new app should utilize a list and can either have buttons or swiping for each question.

### Image Credits

All images were either free stock images with no attribution requirement from either pixabay.com or quickly generated on the fly via Gemini.
